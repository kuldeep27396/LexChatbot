...
def sendEmail():
    try:
        if request.json['emailid'] is not None:
            ...
            contact_add = "youranotherdataguy@gmail.com"  ## the email id of the support team
            fromaddr = "youranotherdataguy@gmail.com"   ## the email id from where we are going to send the mail
            ...
            # Authentication
            s.login(fromaddr,"Kp123456#") # give your password here
